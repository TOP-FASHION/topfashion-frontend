...
const ProductsView = observer(({ products = [], layout = 'grid', grid = 'grid-4-sidebar', offcanvas = 'mobile', ...otherProps }: Props) => {
  const { productsStore, productsCategoriesStore, mobileMenuStore } = React.useContext(AppContext)
      ...
      <div className='products-view__options'>
        <div className={viewOptionsClasses}>
          <div className='view-options__filters-button'>
            <button type='button' className='filters-button' onClick={() => mobileMenuStore.openMobileFilter()}>
          ...
          <div className='view-options__legend'>Showing {productsStore.countProducts > productsStore.totalProducts ? productsStore.totalProducts : productsStore.countProducts} of {productsStore.totalProducts} products</div>
