...
const Product = observer(
  ({ layout = 'standard', product, ...otherProps }: Props) => {
      ...
      return attributeSize.length ? (
        <Fragment>
          ...
          <div className="input-radio-label">
            <div className="input-radio-label__list">{options}</div>
          </div>
        </Fragment>
      ) : null;
    };
      ...
      return attributeColor.length ? (
        <Fragment>
          ...
          <div className="input-radio-color">
            <div className="input-radio-color__list">{attributeColor}</div>
          </div>
        </Fragment>
      ) : null;
    };
    ...
    const categories = () => {
      ...
      return (
        <div className="product__tags tags">
          <div className="tags__list">{tags}</div>
        </div>
      );
    };
                ...
                <div className="product__actions">
                  ...
                  <div className="product__actions-item product__actions-item--addtocart">
                    <Button
                      variant="primary"
                      onClick={() =>
                        cartAddProductStore.addProduct(product.id, quantity)
                      }
