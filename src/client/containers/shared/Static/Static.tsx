      ...
      <Fragment>
        {!pageStore.pageContent ? (
          ...
          <Fragment>
            ...
            <PageHeader header={pageStore.pageContent.title.rendered} breadcrumb={breadcrumb} />
            {<StaticContent className='typography' content={pageStore.pageContent.content.rendered} />}
          </Fragment>
        )}
      </Fragment>
    </div>
