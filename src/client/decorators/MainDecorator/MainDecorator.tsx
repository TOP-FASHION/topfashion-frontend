      ...
      <Group className='main-decorator__wrapper'>
        ...
        <Group className='main-decorator__content'>
          <SwitchLang>
            ...
            <Route path='/category' render={() => (<ProductCategoryPage {...props} columns={4} viewMode='grid' sidebarPosition='start' />)} exact />
            <Route path='/category/:categoryId' render={() => (<ProductCategoryPage {...props} columns={4} viewMode='grid' sidebarPosition='start' />)} exact />
